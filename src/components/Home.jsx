  ...
  return (
    <section>
      <div className="search__container">
        ...
        <input className="country__search" placeholder="Eg: Afghanistan , South Africa" onChange={(e) => dataSearch(e.target.value)} />
      </div>
      <div>
      ...
      <div>
        <ul className="container">
          {
      countries.covidData.filter((value) => value.country
        .toLowerCase().includes(querry
